...
var showWeather = function (info, city) {
  ...
  weatherImageEl.innerHTML =
    "<img src='https://openweathermap.org/img/wn/" + weatherImage + ".png'>";
  currentTemperature.textContent = "Temperature: " + info.current.temp + "°F";
  currentWindMph.textContent =
    "Wind Speed: " + info.current.wind_speed + " MPH";
...
var showForecastResults = function (info) {
  ...
  for (var i = 1; i < 6; i++) {
    ...
    dayImageEl.innerHTML =
      "<img src='https://openweathermap.org/img/wn/" + dayImage + ".png'>";
    dayTemperature.classList = "card-text";
    dayTemperature.textContent =
      "Temperature: " + info.daily[i].temp.day + "°F";
